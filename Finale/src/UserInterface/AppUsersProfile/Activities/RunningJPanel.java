 ...
 * @author raunak
 */
public class RunningJPanel extends javax.swing.JPanel {
     ...
     */
    public RunningJPanel(JPanel userProcessContainer, UserAccount account, Enterprise enterprise, String msg) {
        initComponents();
    ...
    public void populateWorkOutComboBox() {
        workOutComboBox.removeAllItems();//Light, Heavy, Power Workout, Unstoppable
        workOutComboBox.addItem("Light");
        workOutComboBox.addItem("Heavy");
        workOutComboBox.addItem("Power Workout");
        workOutComboBox.addItem("Unstoppable");
    }
    ...
    public void populateMusicTypeComboBox() {
        ...
        musicComboBox.addItem("High Notes");
        musicComboBox.addItem("Power Workout");
        musicComboBox.addItem("Running Tempo Mix");
    ...
    private void initComponents() {
        ...
        workOutComboBox = new javax.swing.JComboBox();
        ...
        workOutComboBox.setFont(new java.awt.Font("Segoe UI", 0, 11)); // NOI18N
        workOutComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        workOutComboBox.setPreferredSize(new java.awt.Dimension(150, 25));
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(workOutComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private WebPopOver createPopOver() {
        ...
        popOver.add(new WebLabel("Workout is " + workOutComboBox.getSelectedItem().toString()), grid);
    ...
    public void ChangeApplianceInformation() {
        for (Appliance appliance : userAccount.getApplianceDirectory().getApplianceList()) {
            ...
            if (appliance.getApplianceName().equalsIgnoreCase("Lights")) {
                appliance.setAppInfo("Pulsating to the Music rythm");
            }
            if (appliance.getApplianceName().equalsIgnoreCase("Home Thermostat")) {
                appliance.setAppInfo("Mildy cool evironment");
            }
        }
    }
    ...
    public VitalSign randomVitalsData() {
        ...
        if (workOutComboBox.getSelectedItem().toString().equalsIgnoreCase("Light")) {
            respiratoryRate = (float) (12 + Math.random() * (20 - 12));
            heartRate = (float) (105 + Math.random() * (110 - 105));
            bloodPressure = (float) (95 + Math.random() * (110 - 95));
            temperature = (float) (96 + Math.random() * (99 - 96));
        } else if (workOutComboBox.getSelectedItem().toString().equalsIgnoreCase("Heavy")) {
            respiratoryRate = (float) (20 + Math.random() * (30 - 20));
            heartRate = (float) (110 + Math.random() * (130 - 110));
            bloodPressure = (float) (100 + Math.random() * (115 - 100));
            temperature = (float) (96 + Math.random() * (97 - 96));
        } else if (workOutComboBox.getSelectedItem().toString().equalsIgnoreCase("Power Workout")) {
            respiratoryRate = (float) (30 + Math.random() * (35 - 30));
            heartRate = (float) (130 + Math.random() * (165 - 130));
            bloodPressure = (float) (115 + Math.random() * (130 - 115));
            temperature = (float) (97 + Math.random() * (98 - 97));
        } else if (workOutComboBox.getSelectedItem().toString().equalsIgnoreCase("Unstoppable")) {
            respiratoryRate = (float) (35 + Math.random() * (50 - 35));
            heartRate = (float) (165 + Math.random() * (200 - 165));
            bloodPressure = (float) (130 + Math.random() * (140 - 130));
            temperature = (float) (98 + Math.random() * (99 - 98));
        }
    ...
    private javax.swing.JComboBox workOutComboBox;
